...
const EditPosts = () => {
  ...
  const handleFileChange = (e) => {
    setNewPost({ ...newPost, documents: Array.from(e.target.files) });
  };
  ...
  const handlePostSubmit = async (e) => {
    ...
    newPost.documents.forEach((file) => formData.append('documents', file));
    ...
    try {
      ...
      setPostsData([createdPost, ...postsData]); // Add the new post at the beginning
      setNewPost({ title: '', description: '', documents: [] }); // Reset form
    } catch (error) {
    ...
    <div className="h-screen w-full bg-gray-100">
      ...
      <div className="w-full mx-auto bg-white shadow-lg overflow-y-auto flex-shrink-0 border-r border-gray-200">
        <div className="flex space-x-4 border-b pb-2">
          <button className={`px-4 py-2 text-sm font-medium`}>Content</button>
          <button className={`px-4 py-2 text-sm font-medium border-b-2 border-teal-500`}>Post</button>
          <button className={`px-4 py-2 text-sm font-medium`}>Assignment</button>
        </div>
          ...
          <div className="container mx-auto px-4 py-4 flex items-center">
            ...
            <div className="ml-auto flex gap-2">
              <Button
                ...
                onClick={() => document.getElementById('post-form').classList.toggle('hidden')}
              >
        ...
        {/* Add Post Form */}
        <div id="post-form" className="container mx-auto px-4 py-6 hidden">
          <form onSubmit={handlePostSubmit}>
            <div className="space-y-4">
              ...
              <Button type="submit" className="mt-4 bg-teal-500 hover:bg-teal-600 text-white">
                Submit Post
              </Button>
            </div>
          </form>
